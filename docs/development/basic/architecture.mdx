...
description: >-
  Explore the architecture of Ethos, an open-source AI Agent platform built on
...
Ethos is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of Ethos's architecture design.

## Application Architecture Overview

The overall architecture of Ethos consists of the following core layers:
...
Ethos uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
...
Database operations use Drizzle ORM, with schemas defined in `src/database/schemas/`.
