...
description: >-
  Explore the Ethos development setup, technology stack, and contribution
  guidelines.
tags:
  - Ethos
  - Next.js
...
Welcome to the Ethos Technical Development Getting Started Guide. Ethos is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of Ethos and how to configure and use these technologies in your development environment.
...
Ethos uses a Monorepo architecture
(`@lobechat/` namespace).
...
Ethos uses `react-i18next` for multilingual support,
...
To support developers in better understanding and using the technology stack of Ethos, we provide a comprehensive list of resources and references — [Ethos Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Ethos GitHub Discussions](https://github.com/lobehub/lobehub/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
