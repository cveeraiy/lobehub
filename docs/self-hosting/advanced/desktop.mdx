---
title: Automatic Synchronization with Ethos Desktop
description: Configure Ethos Desktop for a synchronized experience
tags:
  - Ethos
...
# Automatic Synchronization with Ethos Desktop

Ethos Desktop provides users with an enhanced experience while also expanding the capabilities of Ethos, allowing users to utilize Ethos in offline environments. This document will guide you on how to configure Ethos Desktop and connect it to your self-hosted instance.

## System Requirements

Ethos Desktop is built using Electron and supports the following operating systems:
...
The version release of Ethos Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of Ethos Desktop.
...
Ethos Desktop can connect to your self-hosted Ethos instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying Ethos using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
1. Open Ethos Desktop.
2. Click the Wi-Fi icon in the upper right corner.
3. Enter the address of your self-hosted instance (e.g., `https://your-Ethos-instance.com`).
...
**Issue:** After clicking the authorization button, a 502 Bad Gateway error occurs during the login redirect.
...
- Example file names:
  - Apple Silicon: `Ethos-Beta-1.83.6-arm64.dmg` or `Ethos-Beta-1.83.6-arm64-mac.zip`
  - Intel: `Ethos-Beta-1.83.6-x64.dmg` or `Ethos-Beta-1.83.6-mac.zip`
