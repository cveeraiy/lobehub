...
description: >-
  Learn how to import and export configuration settings for Ethos via URL.
...
Ethos support import settings from external URL to quickly set up Ethos configuration.
...
<Callout type={'warning'}>
  Ethos does not verify the correctness of the settings parameters in the URL, nor provide
