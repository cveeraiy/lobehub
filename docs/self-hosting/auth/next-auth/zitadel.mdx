---
title: Configure ZITADEL Authentication Service for Ethos
description: >-
  Learn how to configure ZITADEL Authentication Service for Ethos deployment,
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that Ethos is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use Ethos using existing
