---
title: Configuring Auth0 Authentication for Ethos
description: >-
  Learn how to configure Auth0 SSO for Ethos, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. Ethos requires user email for authentication.
