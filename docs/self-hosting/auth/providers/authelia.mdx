---
title: Configuring Authelia Authentication for Ethos
description: >-
  Learn how to configure Authelia SSO for Ethos, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for Ethos. Use `authelia` for Authelia                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use Ethos.
</Callout>
