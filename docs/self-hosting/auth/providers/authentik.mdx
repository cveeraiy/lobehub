---
title: Configuring Authentik Authentication for Ethos
description: >-
  Learn how to configure Authentik SSO for Ethos, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for Ethos. Use `authentik` for Authentik                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use Ethos.
</Callout>
