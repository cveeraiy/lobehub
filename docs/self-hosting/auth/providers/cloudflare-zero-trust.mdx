---
title: Configuring Cloudflare Zero Trust Authentication for Ethos
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for Ethos, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for Ethos. Use `cloudflare-zero-trust`                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use Ethos.
</Callout>
