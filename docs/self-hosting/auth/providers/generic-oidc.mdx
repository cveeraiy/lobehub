---
title: Configuring Generic OIDC Authentication for Ethos
description: >-
  Learn how to configure any OpenID Connect provider for Ethos using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate Ethos with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
