---
title: Configuring Logto Authentication for Ethos
description: >-
  Learn how to configure Logto SSO for Ethos, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `Ethos`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for Ethos. Use `logto` for Logto                                 |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to Ethos.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use Ethos.
</Callout>
