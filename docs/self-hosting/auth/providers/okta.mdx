---
title: Configuring Okta Authentication for Ethos
description: >-
  Learn how to configure Okta SSO for Ethos, including creating an application
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for Ethos. Use `okta` for Okta                                   |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use Ethos.
</Callout>
