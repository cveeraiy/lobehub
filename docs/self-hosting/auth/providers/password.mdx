---
title: Configuring Email/Password Authentication for Ethos
description: >-
  Learn how to configure email and password authentication for Ethos,
...
Ethos supports traditional email and password authentication out of the box.
