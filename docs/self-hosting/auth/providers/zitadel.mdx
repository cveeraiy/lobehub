---
title: Configuring ZITADEL Authentication for Ethos
description: >-
  Learn how to configure ZITADEL SSO for Ethos, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for Ethos. Use `zitadel` for ZITADEL                             |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use Ethos.
</Callout>
