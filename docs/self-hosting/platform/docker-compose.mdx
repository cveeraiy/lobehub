---
title: Deploying Ethos with Docker Compose
description: >-
  Learn how to deploy the Ethos service using Docker Compose, including
...
# Deploying Ethos Server Database Version with Docker Compose
...
<Steps>
  ...
  Visit your Ethos service at [http://localhost:3210](http://localhost:3210).
</Steps>
...
<Steps>
  ...
  You can access your Ethos service at `http://your_server_ip:3210`.
</Steps>
...
<Steps>
  ...
  - Domain setup for the Ethos service: `lobe.example.com`
  ...
  <Callout type="tip">
    **Single Domain Deployment**
    ...
    - Domain setup for the Ethos service: `lobe.example.com:${PORT1}`
...
Ethos needs to provide a public access URL for object files for the LLM service provider, so you need to configure the S3 Endpoint:
...
For production deployments with a custom domain and HTTPS, configure a reverse proxy in front of Ethos.
