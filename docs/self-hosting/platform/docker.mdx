---
title: Deploying Ethos Database with Docker
description: >-
  Learn how to deploy the Ethos server database version using Docker on Linux
  and local machines.
tags:
  - Ethos
  - Docker
...
Here is the process for deploying the Ethos server database version on a Linux server:
...
<Steps>
  ...
  <Callout type="info">
    ...
    components for Ethos to implement RAG and knowledge base search.
  </Callout>
...
The data version of Ethos also supports direct use on a local Mac/Windows machine.
