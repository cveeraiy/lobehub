---
title: Build Your Own Ethos - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy Ethos. Choose the platform that best suits your needs.
tags:
  - Ethos
  - Deployment Platform
  - Vercel
...
# Build Your Own Ethos

Ethos can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, Ethos supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

Ethos consists of several key components:
...
Before deploying Ethos, gather the following:
...
5. **Regular updates** — Keep Ethos and dependencies up to date
