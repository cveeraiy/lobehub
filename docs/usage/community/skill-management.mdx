...
| ---------------------- | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**     | Capabilities built into Ethos        | Artifacts, Sandbox, GTD, Notebook, Memory |
| **Ethos Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **Ethos** — Built-in tools and Ethos-native integrations (Linear, Microsoft, Twitter, Klavis services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. Ethos Integrations and Klavis services require an OAuth connection:

1. In the Skill Store, go to the **Ethos** tab
...
**Integrations** — Built-in tools, Ethos-connected services, and Klavis integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
