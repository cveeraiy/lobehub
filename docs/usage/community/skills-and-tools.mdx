...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with Ethos:
    ...
    Built-in skills are maintained by the Ethos team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the Ethos marketplace:
...
Ethos includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the Ethos marketplace:
...
MCP is Ethos's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
