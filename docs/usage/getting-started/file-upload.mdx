...
Ethos provides comprehensive file upload capabilities, enabling AI agents to access, analyze, and reference documents, images, code, and other files during conversations.
...
Ethos includes an integrated file viewer:
...
- Files are stored in your Ethos instance
