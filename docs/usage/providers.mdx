---
title: Using Multiple Model Providers in Ethos
description: >-
  Learn about the latest developments in Ethos's support for multiple model
...
# Using Multiple Model Providers in Ethos
...
Ethos integrates with 70+ AI model providers:
