---
title: Using the Anthropic Claude API Key in Ethos
description: >-
  Learn how to configure and use the Anthropic Claude API in Ethos, including
...
# Using Anthropic Claude in Ethos

<Image alt={'Using Anthropic Claude in Ethos'} cover src={'/blog/assets17870709/620b956b-dcb2-442a-8bb1-9aa22681dfa4.webp'} />

The Anthropic Claude API is now publicly available. This guide will walk you through how to use [Anthropic Claude](https://www.anthropic.com/api) in Ethos:
...
<Steps>
  ...
  ### Step 2: Configure Anthropic Claude in Ethos
...
That's it! You’re now ready to use Anthropic Claude models in Ethos for conversations.
