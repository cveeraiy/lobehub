---
title: Using Cloudflare Workers AI in Ethos
description: >-
  Learn how to configure and use the Cloudflare Workers AI API Key in Ethos to
...
# Using Cloudflare Workers AI in Ethos
...
This guide will walk you through how to use Cloudflare Workers AI in Ethos:
...
<Steps>
  ...
  ### Step 2: Configure Cloudflare Workers AI in Ethos
...
You’re all set! You can now start using Cloudflare Workers AI models for conversations in Ethos.
