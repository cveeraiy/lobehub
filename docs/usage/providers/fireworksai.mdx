---
title: Using Fireworks AI in Ethos
description: >-
  Learn how to configure and use Fireworks AI's API Key in Ethos to start
...
This guide will walk you through how to use Fireworks AI within Ethos.
...
<Steps>
  ...
  ### Step 2: Configure Fireworks AI in Ethos
...
And that’s it! You’re now ready to start using Fireworks AI models in Ethos for conversations and interactions.
