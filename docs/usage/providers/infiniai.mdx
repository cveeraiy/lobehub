---
title: Using Infini-AI in Ethos
description: >-
  Learn how to configure and use Infini-AI's API Key in Ethos to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into Ethos.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in Ethos

  - Open Ethos and go to the "Settings" page
