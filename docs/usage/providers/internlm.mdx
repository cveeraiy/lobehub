---
title: Using InternLM in Ethos
description: >-
  Learn how to configure and use your InternLM API Key in Ethos to start
...
This guide will walk you through how to use InternLM within Ethos.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Ethos
...
You’re all set! You can now start using InternLM-powered models in Ethos for conversations and interactions.
