---
title: Using Nvidia NIM API Key in Ethos
description: >-
  Learn how to configure and use Nvidia NIM AI models in Ethos, obtain your
...
# Using Nvidia NIM in Ethos

<Image alt={'Using Nvidia NIM in Ethos'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in Ethos:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Ethos

  - Go to the `App Settings` section in Ethos and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in Ethos for your conversations.
