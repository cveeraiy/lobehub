---
title: Using the Local Qwen Model in Ethos
description: >-
  Easily chat with the locally deployed Qwen model through Ethos's integration
...
<Image alt={'Using Qwen in Ethos'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
Now, thanks to Ethos’s integration with [Ollama](https://ollama.com/), you can easily use the Qwen model locally within Ethos.

This guide will walk you through how to use the locally deployed Qwen model in Ethos:
...
You’re now ready to start chatting with the local Qwen model in Ethos.
