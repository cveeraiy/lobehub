---
title: Using PPIO API Key in Ethos
description: >-
  Learn how to integrate PPIO's LLM API into Ethos. Follow these steps to
  register a PPIO account, create an API key, and configure it in Ethos.
tags:
  - PPIO
  - PPInfra
  - DeepSeek
...
<Image alt={'Using PPIO in Ethos'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />
...
This guide will walk you through how to use PPIO in Ethos:
...
<Steps>
  ...
  ### Step 3: Configure PPIO in Ethos

  - Open the Settings panel in Ethos.
  - Under the "AI Providers" section, find and select "PPIO".
  - Enable PPIO and paste in your API key.

  <Image alt={'Enter PPIO API Key in Ethos'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
That's it! You're now ready to use PPIO's models for conversations in Ethos.
