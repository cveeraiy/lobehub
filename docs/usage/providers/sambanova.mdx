---
title: Using the SambaNova API Key in Ethos
description: >-
  Learn how to configure and use SambaNova models in Ethos, obtain your API
...
# Using SambaNova in Ethos

<Image alt={'Using SambaNova in Ethos'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in Ethos:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Ethos

  - Go to the `App Settings` section in Ethos
...
You're now ready to start chatting with models powered by SambaNova in Ethos.
