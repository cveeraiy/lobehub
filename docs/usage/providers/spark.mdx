---
title: Using iFLYTEK Spark in Ethos
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in Ethos to start
...
This guide will walk you through how to use iFLYTEK Spark in Ethos.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in Ethos
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in Ethos.
