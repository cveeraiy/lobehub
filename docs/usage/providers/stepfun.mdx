---
title: Using the Stepfun API Key in Ethos
description: >-
  Learn how to configure and use Stepfun's AI models in Ethos, including how
...
# Using Stepfun in Ethos

<Image alt={'Using Stepfun in Ethos'} cover src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'} />
...
This guide will walk you through how to use Stepfun in Ethos:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in Ethos
...
And that’s it! You’re now ready to start chatting with AI models powered by Stepfun in Ethos.
