---
title: Using Tencent Cloud API Key in Ethos
description: >-
  Learn how to configure and use Tencent Cloud AI models in Ethos, obtain your
...
# Using Tencent Cloud in Ethos

<Image alt={'Using Tencent Cloud in Ethos'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into Ethos:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Ethos

  - Open Ethos and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in Ethos for conversations.
