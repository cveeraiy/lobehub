---
title: 在 Ethos 中使用腾讯云 API Key
description: 学习如何在 Ethos 中配置和使用腾讯云 AI 模型，获取 API 密钥并开始对话。
tags:
  - Ethos
  - 腾讯云
  - API密钥
...
至此你已经可以在 Ethos 中使用腾讯云提供的模型进行对话了。
