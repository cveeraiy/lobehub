---
title: Using Vercel AI Gateway in Ethos
description: Learn how to integrate and use the unified API of Vercel AI Gateway in Ethos
tags:
  - Ethos
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in Ethos
...
This guide will walk you through how to use Vercel AI Gateway within Ethos.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Ethos
...
That's it! You can now start chatting in Ethos using models provided by Vercel AI Gateway.
