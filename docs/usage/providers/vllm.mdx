---
title: Using vLLM API Key in Ethos
description: >-
  Learn how to configure and use vLLM language models in Ethos, obtain an API
...
<Image alt={'Using vLLM in Ethos'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in Ethos:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Ethos

  - Open the `App Settings` panel in Ethos
...
You're now ready to use vLLM-powered models in Ethos for conversations.
