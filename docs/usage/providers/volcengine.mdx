---
title: Using Volcengine API Key in Ethos
description: >-
  Learn how to configure and use Volcengine AI models in Ethos, obtain your
...
# Using Volcengine in Ethos

<Image alt={'Using Volcengine in Ethos'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />
...
This guide will walk you through how to use Volcengine in Ethos:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in Ethos

  - Open the `App Settings` in Ethos and go to the `AI Service Providers` section
...
You're now ready to start chatting with models powered by Volcengine in Ethos.
