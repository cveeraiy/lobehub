---
title: Using Wenxin Qianfan in Ethos
description: >-
  Learn how to configure and use the Wenxin Qianfan API Key in Ethos to start
...
This guide will walk you through how to use Wenxin Qianfan in Ethos.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in Ethos
...
Now you're all set to start using Wenxin Qianfan models for conversations in Ethos.
