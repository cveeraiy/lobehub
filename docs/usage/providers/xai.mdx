---
title: Using xAI in Ethos
description: >-
  Learn how to configure and use xAI's API Key in Ethos to start chatting and
  interacting.
tags:
  - Ethos
  - xAI
...
This guide will walk you through how to use xAI within Ethos.
...
You’re now ready to start using xAI-powered models in Ethos for conversations and interactions.
