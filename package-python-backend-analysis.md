...
| `builtin-tool-brief`               | Shared tool                | Brief manifest/types.                                                             | Python has `app/routers/briefs.py` and `app/services/brief`.                                                                        |
| `builtin-tool-calculator`          | Mixed tool                 | Calculator manifest, prompt, executor, lightweight client render.                 | Python has `app/tools/calculator.py`; compare behavior and output shape.                                                            |
...
| `builtin-tool-cron`                | Backend tool               | Cron tool runtime/executor.                                                       | Direct overlap with `app/routers/agent_cron_jobs.py` and task scheduler services.                                                   |
...
| `builtin-tool-lobe-agent`          | Backend tool               | Lobe agent executor/tool definitions.                                             | Compare with `app/tools/lobe_agent_tool.py` and `ai_agent` service.                                                                 |
...
| `builtin-tool-skill-maintainer`    | Shared tool                | Skill maintainer manifest/types.                                                  | Compare identifiers/contracts with Python skill service if enabled.                                                                 |
...
| `builtin-tool-task`                | Backend tool               | Task tool manifest/executor.                                                      | Strong overlap with `app/routers/tasks.py`, `app/services/task`, and `app/tools/task_tool.py`.                                      |
| `builtin-tool-topic-reference`     | Backend tool               | Topic reference executor.                                                         | Compare with `app/routers/topics.py` and `app/tools/topic_reference.py`.                                                            |
...
| `builtin-tool-web-onboarding`      | Mixed tool                 | Web onboarding tool UI/runtime/utilities.                                         | Compare with `app/services/onboarding` and onboarding/auth routes if Python owns this flow.                                         |
