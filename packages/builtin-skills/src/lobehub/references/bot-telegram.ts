...
- **Secret Token** (optional): a custom string you define; Ethos includes it in webhook requests so you can verify they genuinely come from Ethos — leave blank unless you have a security requirement
