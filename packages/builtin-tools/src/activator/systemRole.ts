...
- User mentions: "SKILL.md", "Ethos Skills", "skill store", "install skill", "search skill"
- User provides a GitHub link to install a skill (e.g., github.com/xxx/xxx containing SKILL.md)
- User mentions installing from Ethos marketplace
- User provides Ethos skill URLs like: \`https://lobehub.com/skills/{identifier}/skill.md\` → extract identifier and use \`importFromMarket\`
...
2. **For Ethos skill URLs** (e.g., \`https://lobehub.com/skills/{identifier}/skill.md\`):
...
- **SKILL-FIRST: Any mention of skills, SKILL.md, GitHub skill links, or Ethos marketplace → activate \`lobe-skill-store\` FIRST, no exceptions.**
