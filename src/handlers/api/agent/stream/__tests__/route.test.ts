...
describe('/api/agent/stream route', () => {
  ...
  describe('GET handler', () => {
    it('should return 400 when operationId parameter is missing', async () => {
      const request = new Request('https://test.com/api/agent/stream');
    ...
    it('should return SSE stream with correct headers when operationId is provided', async () => {
      const request = new Request('https://test.com/api/agent/stream?operationId=test-operation');
      const response = await GET(request);
...
\n`,
  ...
  describe('Parameter validation', () => {
    it('should handle operationId with special characters', async () => {
      ...
      const request = new Request(`https://test.com/api/agent/stream?operationId=${operationId}`);
    ...
    it('should handle invalid URL gracefully', async () => {
      const request = new Request('https://test.com/api/agent/stream?operationId=');
