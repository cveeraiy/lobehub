export default {
  ...
  'claudeCodeInstallGuide.reason': 'Ethos could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Ethos could not start Codex: {{message}}',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of Ethos. Ethos is not responsible for any consequences arising from this shared content.',
  ...
  'taskList.unassignedHint': 'Ethos AI will run this task when no assignee is set',
