export default {
  ...
  'agentOnboardingPromo.description':
    'Set up your agent teams in a quick chat with Ethos AI. Your existing agents remain unchanged.',
  ...
  'botIntegrationBanner.title': 'Add Channels to Ethos AI',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Ethos Cloud.',
