export default {
  ...
  'createGuide.func1.title': 'Submit in Ethos',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Ethos Community.',
  'footer.title': 'Share your creation on Ethos Community today',
  ...
  'models.providerInfo.apiTooltip': 'Ethos supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Ethos Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Ethos automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Ethos marketplace with one click.',
