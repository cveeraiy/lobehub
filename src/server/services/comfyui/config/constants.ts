...
export const FLUX_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    DEV: 'Ethos/%year%-%month%-%day%/FLUX_Dev',
    KONTEXT: 'Ethos/%year%-%month%-%day%/FLUX_Kontext',
    KREA: 'Ethos/%year%-%month%-%day%/FLUX_Krea',
    SCHNELL: 'Ethos/%year%-%month%-%day%/FLUX_Schnell',
  },
} as const;
...
export const SD_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    CUSTOM: 'Ethos/%year%-%month%-%day%/CustomSD',
    SD15: 'Ethos/%year%-%month%-%day%/SD15',
    SD35: 'Ethos/%year%-%month%-%day%/SD35',
    SDXL: 'Ethos/%year%-%month%-%day%/SDXL',
  },
} as const;
