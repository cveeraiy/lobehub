/**
 * User service — REST API version.
 *
 * Drop-in replacement for `src/services/user/index.ts` (TRPC version).
 * Calls the Python backend's `/api/user/*` REST endpoints directly.
 *
 * ## How to switch
 * In every store/executor that imports from `@/services/user`:
 * ```diff
 * -import { userService } from '@/services/user';
 * +import { userService } from '@/services/user/index.rest';
 * ```
 */
